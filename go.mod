module github.com/diptadas/golang-examples
...
require (
	...
	github.com/rubenv/sql-migrate v0.0.0-20180214095000-7067d4c948a0
	...
	golang.org/x/oauth2 v0.0.0-20180103155054-876b1c6ee618
